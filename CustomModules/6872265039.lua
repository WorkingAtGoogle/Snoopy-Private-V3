...
local function GetURL(scripturl)
	if shared.VapeDeveloper then
		...
		return game:HttpGet("https://raw.githubusercontent.com/WorkingAtGoogle/Snoopy-Private-V3/main/"..scripturl, true)
	end
end
...
local function getcustomassetfunc(path)
	if not betterisfile(path) then
		...
		local req = requestfunc({
			Url = "https://raw.githubusercontent.com/WorkingAtGoogle/Snoopy-Private-V3/main/"..path:gsub("vape/assets", "assets"),
			Method = "GET"
		})
